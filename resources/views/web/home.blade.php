            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Cadastro</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ url('/ordem.index') }}">Ordem de Fornecimentos</a></li>  
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ url('/processo.index') }}">Processos</a></li>                            
                            <li><i class="fa fa-id-badge"></i><a href="{{ url('/lista-fornecedor') }}">Fornecedores</a></li>
                            <li><i class="fa fa-bars"></i><a href="ui-tabs.html">Categorias</a></li>
                            <li><i class="fa fa-share-square-o"></i><a href="ui-social-buttons.html">Material</a></li>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="{{ url('profile') }}"><i class="fa fa-cog"></i> Editar Perfil</a>
